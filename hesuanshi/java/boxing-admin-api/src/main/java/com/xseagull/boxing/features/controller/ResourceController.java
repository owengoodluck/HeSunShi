...
public class ResourceController {
	 ...
	 * @return
	 */
	@GetMapping("/findResourceByNumber/{type}/{number}")
	public ResultData findResourceByTypeAndNumber(@PathVariable String type, @PathVariable String number) {
		return resourceService.findResourceByTypeAndNumber(type,number);
	}
