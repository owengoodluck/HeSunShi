...
public class ReflectUtils {
     ...
     * @return 目标注解实例
     */
	public static Annotation getClassAnnotation(@SuppressWarnings("rawtypes") Class targetAnnotationClass, Object obj) {
     ...
     * @return 目标注解实例
     */
    public static Annotation getClassAnnotation(@SuppressWarnings("rawtypes") Class targetAnnotationClass, String clazz) {
        try {
