...
public class ServiceMsgUtils {
	 ...
	 * @return
	 */
	public static String sendAppletsMsg(String accessToken, String touser, String templateId, String page, String formId, Map<String,TemplateData> m) {
		String rs = null;
		try {
	 ...
	 * 给微信服务号发送服务通知
	 * @param touser 用户openid
	 * @param templateId 模板id(d0lJ2gW5UTvzVIwViMvTQ9OW0GjkqcLByEXYY-1lhtc)
	 * @param m 参数
	 * @return
	 */
	public static String sendServiceNumberMsg(String accessToken, String touser, String templateId, Map<String,TemplateData> m) {
		String rs = null;
		try {

			String param= JsonUtils.getServiceNumberJsonString(touser, templateId, m);
