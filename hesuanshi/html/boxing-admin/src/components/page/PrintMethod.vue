    ...
    <div>
        ...
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-menu"></i> 印刷方式管理</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <el-col :span="24" class="warp-main">
            ...
            <el-form :inline="true" :model="searchForm">
                ...
                <el-form-item>
                    ...
                    <el-button type="primary" icon="el-icon-plus" @click="showAddDialog" v-hasPermission="'printMethod:add'">新增</el-button>
                </el-form-item>
            </el-form>
            <!--列表-->
                ...
                <el-table-column label="操作" width="181">
                    <template slot-scope="scope">
                        <el-button size="small" icon="el-icon-edit"
                            @click="showEditDialog(scope.$index, scope.row)" v-hasPermission="'printMethod:edit'">编辑</el-button>
                    </template>
                </el-table-column>
            </el-table>
            <!--分页-->
        ...
        <!--新增分类界面-->
        <el-dialog width="960px" title="新增印刷方式" :visible.sync ="addFormVisible" :close-on-click-modal="false">
            <el-form :model="addForm" status-icon label-width="120px" :rules="addFormRules" ref="addForm">
                <el-row>
                    <el-col :span="24">
                        <el-form-item label="印刷方式" prop="name">
        ...
        <!--编辑界面-->
        <el-dialog width="960px" title="编辑印刷方式" :visible.sync ="editFormVisible" :close-on-click-modal="false">
    ...
    export default {
        data() {
            return {
                ...
                addFormRules: {
                    name: [
                        {required: true, message: '请输入印刷方式', trigger: 'blur'}
                    ]
                },
                addForm: {
                    name: ''
        ...
        methods: {
            ...
            addSubmit: function () {
                ...
                this.$refs.addForm.validate((valid) => {
                    if (valid) {
                        ...
                        that.$axios.post('printMethod/insert', params)
            ...
            editSubmit: function () {
                ...
                this.$refs.editForm.validate((valid) => {
                    if (valid) {
                        ...
                        that.$axios.post('printMethod/update', params)
                        .then(function (response) {
                            if (response.data.code == 200){
            ...
            updateStatus:function(row){
                ...
                that.$axios.post('printMethod/updateStatus', params)
                .then(function (response) {
                    if (response.data.code == 200){
