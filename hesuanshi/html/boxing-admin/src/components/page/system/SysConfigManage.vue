    ...
    <div>
        ...
        <div class="crumbs">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>配置参数管理</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <el-col :span="24" class="warp-main">
            ...
            <el-form :inline="true" :model="searchForm">
                <el-form-item>
                    <el-input v-model.trim="searchForm.itemKey" placeholder="参数名称" clearable></el-input>
                </el-form-item>
            ...
            <el-table :data="tableData" border ref="multipleTable" highlight-current-row stripe>
                ...
                <el-table-column prop="itemKey" label="参数名称"></el-table-column>
                <el-table-column prop="itemValue" label="参数值"></el-table-column>
        ...
        <!--新增配置参数界面-->
        <el-dialog title="新增参数" :visible.sync ="addFormVisible" :close-on-click-modal="false" width="960px">
            <el-form :model="addForm" status-icon label-width="80px" :rules="addFormRules" ref="addForm">
                <el-row>
                    <el-col :span="24">
                        <el-form-item label="参数名称" prop="itemKey">
                            <el-input v-model.trim="addForm.itemKey" clearable autofocus></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span="24">
                        <el-form-item label="参数值" prop="itemValue">
                            <el-input v-model.trim="addForm.itemValue" clearable autofocus></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
        ...
        <!--编辑配置参数界面-->
        <el-dialog title="编辑参数" :visible.sync ="editFormVisible" :close-on-click-modal="false" width="960px">
            <el-form :model="editForm" status-icon label-width="100px" :rules="editFormRules" ref="editForm">
                <el-row>
                    <el-col :span="24">
                        <el-form-item label="参数名称" prop="itemKey">
                            <el-input v-model.trim="editForm.itemKey" clearable autofocus></el-input>
                        </el-form-item>
                        <el-form-item label="参数值" prop="itemValue">
                            <el-input v-model.trim="editForm.itemValue" clearable autofocus></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                 <el-form-item label="备注">
...
<script>
    export default {
        data() {
            return {
                url: 'sys_config/queryConfigByPage',
                tableData: [],
                cur_page: 1,
                select_word: '',
                pageNo: 1,
        ...
        methods: {
            ...
            getData: function(){
                let that = this;
                let params = '?pageNo=' + that.cur_page + '&itemKey=' + that.searchForm.itemKey;
                that.$axios.get(that.url + params).then((res) => {
                    if(res.data.code == 200){
                        if(res.data.data.list.length == 0) {
                            that.cur_page = that.cur_page - 1;
                            that.pageNo = that.pageNo - 1;
                            let params1 = '?pageNo='+ that.cur_page + '&itemKey=' + that.searchForm.itemKey;
            ...
            addSubmit: function () {
                ...
                this.$refs.addForm.validate((valid) => {
                    if (valid) {
                        ...
                        that.$axios.post('sys_config/insertConfig', params)
            ...
            editSubmit: function () {
                ...
                this.$refs.editForm.validate((valid) => {
                    if (valid) {
                        ...
                        that.$axios.post('sys_config/updateConfig', params)
                        .then(function (response) {
                            if (response.data.code == 200){
            ...
            deleteSubmit: function (index, row) {
                ...
                if(row.itemKey == '中青汇智'){
                    ...
                    that.search();
                    that.$axios.post('sys_config/deleteConfig/' + row.id)
                    .then(function (response) {
                        if (response.data.code == 200){
