    ...
    <div>
        ...
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-menu"></i> 盒型分类管理</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <el-col :span="24" class="warp-main">
            ...
            <el-form :inline="true" :model="searchForm">
                ...
                <el-form-item>
                    ...
                    <el-button type="primary" icon="el-icon-plus" @click="showAddDialog" v-hasPermission="'boxTypeClassify:add'">新增</el-button>
                </el-form-item>
            </el-form>
            <!--列表-->
                ...
                <el-table-column label="操作" width="181">
                    <template slot-scope="scope">
                        <el-button size="small" icon="el-icon-edit"
                            @click="showEditDialog(scope.$index, scope.row)" v-hasPermission="'boxTypeClassify:edit'">编辑</el-button>
                    </template>
                </el-table-column>
            </el-table>
            <!--分页-->
        ...
        <!--新增分类界面-->
        <el-dialog width="960px" title="新增盒型分类" :visible.sync ="addFormVisible" :close-on-click-modal="false">
            <el-form :model="addForm" status-icon label-width="120px" :rules="addFormRules" ref="addForm">
                <el-row>
                    <el-col :span="24">
                        <el-form-item label="盒型分类名称" prop="name">
        ...
        <!--编辑界面-->
        <el-dialog width="960px" title="编辑盒型分类" :visible.sync ="editFormVisible" :close-on-click-modal="false">
...
<script>
    export default {
        data() {
            return {
                url: 'boxTypeClassify/queryByPage',
                tableData: [],
                cur_page: 1,
                pageNo: 1,
                total: 0,
        ...
        methods: {
            ...
            addSubmit: function () {
                ...
                this.$refs.addForm.validate((valid) => {
                    if (valid) {
                        ...
                        that.$axios.post('boxTypeClassify/insert', params)
            ...
            editSubmit: function () {
                ...
                this.$refs.editForm.validate((valid) => {
                    if (valid) {
                        ...
                        that.$axios.post('boxTypeClassify/update', params)
                        .then(function (response) {
                            if (response.data.code == 200){
            ...
            updateStatus:function(row){
                ...
                that.$axios.post('boxTypeClassify/updateStatus', params)
                .then(function (response) {
                    if (response.data.code == 200){
